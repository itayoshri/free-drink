...
export default function AccountPopup({ user }: { user: User }) {
  ...
  return (
    <div className="flex flex-col gap-4 absolute top-full -mt-2 h-fit bg-white dark:bg-zinc-900 text-black dark:text-white rounded-xl border-[1px] p-4 border-gray-300 dark:border-zinc-600 pl-20">
